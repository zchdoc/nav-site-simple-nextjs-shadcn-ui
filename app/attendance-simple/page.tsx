              ...
              <Space direction="vertical">
                <Card>
                  ...
                  <CardContent className="space-y-2">
                    ...
                    <Space size={8} align={"baseline"}>
                      ...
                      >
                        {btnQueryLoading ? "Querying..." : "Query"}
                      </Button>
                      <br/>
                    </Space>
                    {/*{attUserName && (*/}
                    {/*  <Alert*/}
                    {/*    message={`查询用户 : ${attUserName}`}*/}
                    {/*    type="success"*/}
                    {/*    description={`${attQueryTimeStart} - ${attQueryTimeEnd}`}*/}
                    {/*    showIcon*/}
                    {/*    closable*/}
                    {/*  />*/}
                    {/*)}*/}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    >
                      {btnConfirmLoading ? "Processing..." : "模拟"}
                    </Button>
                  </CardContent>
                </Card>
              </Space>
            </Col>
            <Col span={24 - leftRowWith}>
              <AttendanceCalendar
                attendanceData={formatAttendanceData(attendanceRecords)}
              />
              {attUserName && (
                <Alert
                  message={`查询用户 : ${attUserName} ${attQueryTimeStart} - ${attQueryTimeEnd}`}
                  type="success"
                  description={``}
                  showIcon
                  closable
